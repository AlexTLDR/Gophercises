...
func main() {
	...
	report("10 millinon int array")

	// 3. copy the array to a new array.
	copyTenMillion := tenMillion

	// 4. print the memory usage
	report("after copying the 10 million int array")
